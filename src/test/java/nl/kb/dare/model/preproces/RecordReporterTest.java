...
public class RecordReporterTest {
    ...
    public void setup() throws IOException {
        ...
        final Record one = RecordDaoTest.makeRecord(
                RecordDaoTest.makeRecordHeader("id-1", "d-1", OaiStatus.AVAILABLE),
                1, 1L);
        final Record two = RecordDaoTest.makeRecord(
                RecordDaoTest.makeRecordHeader("id-2", "d-2", OaiStatus.AVAILABLE),
                1, 2L);
        final Record three = RecordDaoTest.makeRecord(
                RecordDaoTest.makeRecordHeader("id-3", "d-3", OaiStatus.AVAILABLE),
                2, 3L);
        final Record four = RecordDaoTest.makeRecord(
                RecordDaoTest.makeRecordHeader("id-4", "d-4", OaiStatus.AVAILABLE),
                2, 4L);
