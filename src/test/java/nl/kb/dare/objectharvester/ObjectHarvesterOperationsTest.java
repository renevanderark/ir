...
public class ObjectHarvesterOperationsTest {
    ...
    public void generateManifestShouldTransformTheResponseTheXsltTransformer() throws IOException, TransformerException {
        ...
        final boolean result = instance.generateManifest(processingStorageHandle, oaiUrl, oaiSet, "checksum-date", new HarvesterVersion(),
                (errorReport) -> {});
    ...
    public void generateManifestShouldLogAnyTransformerException() throws IOException, TransformerException {
        ...
        final boolean result = instance.generateManifest(processingStorageHandle, oaiUrl, oaiSet, "checksum-date", new HarvesterVersion(), onError);
